...
static ucg_status_t ucg_planc_ucx_gather_linear_op_discard(ucg_plan_op_t *ucg_op)
{
...
static void ucg_planc_ucx_gather_linear_op_init(ucg_planc_ucx_op_t *ucx_op)
{
                                                        ...
                                                        const ucg_coll_args_t *args)
{
    ...
    ucg_status_t status = UCG_CLASS_CONSTRUCT(ucg_plan_op_t, &ucx_op->super, vgroup,
                                              ...
                                              ucg_planc_ucx_gather_linear_op_discard,
                                              args);
    ...
    ucg_planc_ucx_gather_linear_op_init(ucx_op);
    return ucx_op;
