...
/* connnection pattern for different collective operations */
...
enum UCS_S_PACKED ucg_builtin_plan_method_type {
    ...
    UCG_PLAN_METHOD_RECV_V_TERMINAL,   /* recv oparation for scatter */
...
enum ucg_builtin_alltoallv_algorithm {
    ...
    UCG_ALGORITHM_ALLTOALLV_NODE_AWARE_PLUMMER = 2,  /* gather+alltoallv+scatterv*/
...
typedef struct ucg_builtin_plan_phase {
    ...
    ucg_builtin_plan_raben_phase_extend_t raben_extend;  /*extended attribute of Rabenseifner, used by binary block algorithm */
...
typedef struct ucg_builtin_binominal_tree_params {
...
/* Topolopy-Aware Algorithm related functions */
