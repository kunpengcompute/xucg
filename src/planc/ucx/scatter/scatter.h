...
#ifndef UCG_PLANC_UCX_SCATTER_H_
#define UCG_PLANC_UCX_SCATTER_H_
...
typedef struct ucg_planc_ucx_scatter_na_kntree_args {
    ucg_coll_args_t scatter_origin;
    ucg_coll_args_t scatter_inter;
    ucg_coll_args_t scatter_intra;
...
} ucg_planc_ucx_scatter_na_kntree_args_t;

typedef struct ucg_planc_ucx_scatter {
    union {
        struct {
            int32_t idx;
            uint8_t send_type;
        ...
        ucg_planc_ucx_scatter_na_kntree_args_t na_kntree;
    };
} ucg_planc_ucx_scatter_t;

typedef struct ucg_planc_ucx_scatter_config {
    size_t min_bsend;   /* for linear, closed boundary */
    size_t max_bsend;   /* for linear, closed boundary */
    int kntree_degree;  /* for kntree */
    /* configuration of node-aware kntree scatter */
    int na_kntree_inter_degree;
    int na_kntree_intra_degree;
} ucg_planc_ucx_scatter_config_t;
